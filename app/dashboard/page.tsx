...
import { IntelligentKeeper } from '@/components/bonzo/IntelligentKeeper'
import { RegistryAgent } from '@/components/hol/RegistryAgent'
import { HieroLibrary } from '@/components/hiero/HieroLibrary'
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="bg-gray-800 border-b border-gray-700">
        <div className="container mx-auto px-4">
          <div className="flex space-x-8">
            {[
              { id: 'terminal', label: 'Intelligence Terminal', icon: 'fa-brain' },
              { id: 'bonzo', label: 'Bonzo Keeper', icon: 'fa-shield-alt' },
              { id: 'hol', label: 'HOL Registry', icon: 'fa-network-wired' },
              { id: 'hiero', label: 'Hiero Library', icon: 'fa-cube' }
            ].map(tab => (
              <button
                key={tab.id}
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        {activeTab === 'bonzo' && <IntelligentKeeper />}
        {activeTab === 'hol' && <RegistryAgent />}
        {activeTab === 'hiero' && <HieroLibrary />}
      </main>
    </div>
  )
}
